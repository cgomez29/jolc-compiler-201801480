...
function insertarValores(array::Vector{Vector{Vector{Int64}}}) # tipo
    for i in 1:4
        for j in 2:3
...
function imprimirReporte(value::Int64,i::Int64,j::Int64,k::Int64) # tipos
    println(paises[i] * "          " * celulares[j] * "          " * edades[k] * "          ", value);   # NO STRING()
end;

function imprimirScore(array::Vector{Vector{Vector{Int64}}}) # tipo
