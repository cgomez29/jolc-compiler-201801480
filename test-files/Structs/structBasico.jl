...
function crear(personaje::Personaje, juego::Juego)::Compania # tipo
    return Compania(personaje,juego);
end;

function crearPersonaje(nombre::String, color::String) :: Personaje # tipo
    return Personaje(nombre,color);
end;

function crearJuego(nombre::String, horas::Int64)::Juego # tipo
